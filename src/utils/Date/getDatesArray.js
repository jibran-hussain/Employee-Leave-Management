...
export const getDatesArray= async (userId,fromDate,toDate,considerAlreadyApplied)=>{
    try{
        let dates=[]
        let leaveDuration=0;
        ...
        while(startDate <= endDate){
            ...
            if(considerAlreadyApplied) alreadyApplied= await isAlreadyLeave(userId,startDate);
